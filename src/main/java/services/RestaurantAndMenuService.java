...
@Component
public class RestaurantAndMenuService {
    ...
    public RestairantScoreDto getRestaurantsScores() {
        //find all rest in repo and return with scores
        //Scores are in repo
        return null;
    }

    public RestairantScoreDto getRestaurantsScoresOnDate(LocalDate localDate) {
